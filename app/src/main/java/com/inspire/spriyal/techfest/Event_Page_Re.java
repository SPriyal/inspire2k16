...
import android.view.ViewGroup;
        ...
        import com.inspire.spriyal.techfest.fragments_main.pane_1;
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 3:
                    ...
                    return frag3;
                case 4:
                    bundle.putInt("bpos",4);
                    //return new robotics_pane();
                    FragmentA frag4 = new FragmentA();
                    frag4.setArguments(bundle);
                    return frag4;
                case 5:
                    bundle.putInt("bpos",5);
                    //return new robotics_pane();
                    FragmentA frag5 = new FragmentA();
                    frag5.setArguments(bundle);
                    return frag5;
                case 6:
                    bundle.putInt("bpos",6);
                    //return new robotics_pane();
                    FragmentA frag6 = new FragmentA();
                    frag6.setArguments(bundle);
                    return frag6;
                case 7:
                    bundle.putInt("bpos",7);
                    //return new robotics_pane();
                    FragmentA frag7 = new FragmentA();
                    frag7.setArguments(bundle);
                    return frag7;
            }
            return new pane_1();
